        ...
        promise.then(data => {
            ...
            if (data.statusCode == 8015) {
                ...
                if (this.idenVerify) {
                    ...
                    idenVerifyBtn.setAttribute("style", "color: #4BD394");
                ...
                if (result.mobile) {
                    ...
                    operatorVerifyBtn.setAttribute("style", "color: #4BD394");
                ...
                if (result.contact) {
                    ...
                    contactVerifyBtn.setAttribute("style", "color: #4BD394");
                ...
                if (result.more) {
                    ...
                    moreInfoVerifyBtn.setAttribute("style", "color: #4BD394");
                ...
                // } else {
                //     sesameVerifyBtn.setAttribute("style", "color: #4BD394");
