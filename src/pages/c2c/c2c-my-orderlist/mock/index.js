module.exports = {
    ...
    "/wx/v16/LLPayInterface": function(req, res) {
        ...
        var result = {
            ...
            "data": {
                ...
                "no_agree": "",
                "no_order": "369445",
                "notify_url": "http://47.96.12.218:8030/wx/LLNotifyUrl ",
    ...
    "/v3/loanRepaid/app/getWeChatCode": function(req, res){

        var result = {
            code: 0,
            data: "https://openapi-test.qfpay.com/tool/v1/get_weixin_oauth_code?app_code=2DAB13A0AF4D4031820149BCD58188D0&redirect_uri=http://uuserpay.credan.com/v1/pay/payList?fundAccountId=1001&mchid=8w5pdhDJkm&sign=b83c3aa39caa7b76b31e20dbfeaf044d",
            message:'提示信息'
        }
